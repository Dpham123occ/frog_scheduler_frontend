<template>
  ...
  <div class="time">
    ...
    <VueDatePicker v-model="startTime" time-picker :format="formatS" @closed="updateStart" :is-24="false" />
    <span>Select ending time</span>
    <VueDatePicker v-model="endTime" time-picker :format='formatE' @closed="updateEnd" :is-24="false" />
  </div>
</template>
